...
import { ChangePasswordPayloadSchema, ForgotPasswordPayloadSchema, ResetPasswordPayloadSchema } from "./auth.validation";
...
router.post('/reset-password',validateRequest(ResetPasswordPayloadSchema),AuthController.setNewPassword)
